/* F250_SimpleTimer.cpp   Simple Timer library - for handling timed events without using delays
...
#include "F250_SimpleTimer.h"


static inline unsigned long elapsed() { return millis(); }


F250_SimpleTimer::F250_SimpleTimer() {
...
int F250_SimpleTimer::findFirstFreeSlot() {
    int i;
...
int F250_SimpleTimer::setTimer(long d, timer_callback f, int n) {
    int returnID;
    int freeTimer;
...
int F250_SimpleTimer::setInterval(long d, timer_callback f) {
    return setTimer(d, f, RUN_FOREVER);
}


int F250_SimpleTimer::setTimeout(long d, timer_callback f) {
    return setTimer(d, f, RUN_ONCE);
}


void F250_SimpleTimer::deleteTimer(int ID) 
{
    int timerNum;
...
void F250_SimpleTimer::restartTimer(int ID) 
{
...
boolean F250_SimpleTimer::isEnabled(int ID) 
{
    int timerNum;
...
void F250_SimpleTimer::enable(int ID) 
{
    int timerNum;
...
void F250_SimpleTimer::disable(int ID) 
{
    int timerNum;
...
void F250_SimpleTimer::toggle(int ID) 
{
    int timerNum;
...
int F250_SimpleTimer::getNumTimers() {
    return numTimers;
}


int F250_SimpleTimer::getTimerNum(int ID)
{
    int timerNum = -1;
